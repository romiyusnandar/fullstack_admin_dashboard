...
export const Customerlist = () => {
  ...
  return (
    <div>
      ...
      <div className='mb-2'>
        <Link className="button is-primary mb-2 mr-2" to="/customers/add">Tambah Baru</Link>
        ...
        <tbody>
          {customers.map((customer, index) => (
            <tr key={customer.uuid}>
              ...
              <td>
                <Link to={`/customer/edit/${customer.uuid}`} className="button is-small is-info mr-2">Edit</Link>
                <button onClick={() => deleteCustomer(customer.uuid)} className="button is-small is-danger">Hapus</button>
              </td>
            </tr>
          ))}
        </tbody>
